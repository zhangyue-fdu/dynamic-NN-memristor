...
semantic_center = torch.load('ResNet_semantic_center_1116_noised_ternary_1207_11_1214.pth')

net = ResNet()
new_m = net.to(device)
# 测试所保存的模型
m_state_dict = torch.load('Resnet_1116_noised.pth')
...
for i in range(epoch):
    ...
    with torch.no_grad():
        ...
        print("epoch:{}, test-accuracy: {},  test_is_early_num:{}".format(i+1, test_accuracy / test_num, test_is_early_num / test_num))
