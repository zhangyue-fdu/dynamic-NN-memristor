...
def analog_system_energy(gpu='3090'):
    ...
    e_gpu_system = 10000*e_gpu_system
    e_gpu_early_exit_system = 10000 * layer1_e_gpu + (10000) * layer2_e_gpu + (10000-416) * layer3_e_gpu + (10000-416-9554) * layer4_e_gpu + \
                                           (30+27+25+10+9+9+9) * layer5_e_gpu + 9 * layer12_e_gpu
    e_mixed_system = layer1_e_mix + layer2_e_mix + layer3_e_mix + layer4_e_mix + layer5_e_mix * 7 + layer12_e_mix
    e_mixed_system = 10000*e_mixed_system
    ...
    num =10000
    #ternary
    e_mix_early_exit_ternary_conv_system = 10000 * layer1_e_mix + 10000 * layer2_e_mix + (10000) * layer3_e_mix + (0) * layer4_e_mix + \
                                           (0) * layer5_e_mix + 9 * layer12_e_mix
    cos_ternary_rram_num = 10000*cos_e_rram_system[0]+10000*cos_e_rram_system[1]+(10000)*cos_e_rram_system[2]+(10000-10000)*cos_e_rram_system[3]+\
                          (0)*cos_e_rram_system[4]+ 0*cos_e_rram_system[11]
    cos_ternary_gpu_num = 10000+10000+(10000)+(10000-10000)+(0)+0
    ...
    e_cim_rram =  10000 * conv1_layer1_e_rram + 10000 * conv2_layer2_e_rram + (10000) * conv3_layer3_e_rram + (10000-10000) * conv4_layer4_e_rram+ \
                                           (0) * layer5_e_rram + 0 * layer12_e_rram
    e_cim_gpu = 10000 * layer1_e_mixgpu + 10000 * layer2_e_mixgpu + (10000) * layer3_e_mixgpu + (10000-10000) * layer4_e_mixgpu+ \
                                           (0) * layer5_e_mixgpu + 0 * layer12_e_mixgpu
    e_cim_adc = 10000 * e_cim_adc_layer1 + 10000 * e_cim_adc_layer2 + (10000) * e_cim_adc_layer3 + (10000-10000) * e_cim_adc_layer4+ \
                                           (0) * e_cim_adc_layer5 + 0 * e_cim_adc_layer12
    ...
    e_mix_early_exit_ternary_system = e_mix_early_exit_ternary_conv_system + e_cos_ternary_gpu + e_cos_ternary_rram

    #rram_system
    e_rram_early_exit_system = 10000 * conv1_layer1_e_rram + 10000 * conv2_layer2_e_rram + (10000) * conv3_layer3_e_rram + (10000-10000) * conv4_layer4_e_rram+ \
                                           (0) * layer5_e_rram + 0 * layer12_e_rram +  e_cos_ternary_rram 
    e_cos_ternary_rram_total = e_avg_rram * (10000*cos_e_rram_system[0]+10000*cos_e_rram_system[1]+(10000)*cos_e_rram_system[2]+(10000-10000)*cos_e_rram_system[3]+\
                          (0)*cos_e_rram_system[4]+ 0*cos_e_rram_system[11])
    e_rram_early_total_system = 10000 * conv1_layer1_e_rram + 10000 * conv2_layer2_e_rram + 10000 * conv3_layer3_e_rram + (10000-10000) * conv4_layer4_e_rram+ \
                                           (0) * layer5_e_rram + 0 * layer12_e_rram + e_cos_ternary_rram_total
    ...
    print((e_gpu_system-e_mix_early_exit_ternary_system)/e_gpu_system)
    print((e_gpu_system-e_mixed_system)/e_gpu_system)
    print((e_gpu_system-e_gpu_early_exit_system)/e_gpu_system)
    print((e_mixed_system-e_mix_early_exit_ternary_system)/e_mixed_system)
