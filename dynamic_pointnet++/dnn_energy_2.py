...
#PointNet++
    ...
    e_gpu_early_exit_system = 908 * layer1_e_gpu + (908-13) * layer2_e_gpu + (908-13-160) * layer3_e_gpu + (908-13-160-162) * layer4_e_gpu + \
                                           (908-13-160-162-188) * layer5_e_gpu + (908-13-160-162-188-253) * layer6_e_gpu + (908-13-160-162-188-253-1) * layer7_e_gpu \
                                            + (908-13-160-162-188-253-1-131) * layer8_e_gpu + (0) * layer9_e_gpu
    ...
    num =908
    #ternary
    e_mix_early_exit_ternary_conv_system = 908 * layer1_e_mix + (908-13) * layer2_e_mix + (908-13-160)  * layer3_e_mix + (908-13-160-162) * layer4_e_mix + \
                                           (908-13-160-162-188) * layer5_e_mix + (908-13-160-162-188-253) * layer6_e_mix + (908-13-160-162-188-253-1) * layer7_e_mix \
                                            + (908-13-160-162-188-253-1-131) * layer8_e_mix + (0) * layer9_e_mix
    cos_ternary_rram_num = 908*cos_e_rram_system[0]+(908-13)*cos_e_rram_system[1]+(908-13-160)*cos_e_rram_system[2]+(908-13-160-162)*cos_e_rram_system[3]+\
                          (908-13-160-162-188)*cos_e_rram_system[4]+ (908-13-160-162-188-253)*cos_e_rram_system[5]+ (908-13-160-162-188-253-1)*cos_e_rram_system[6]\
                          + (908-13-160-162-188-253-1-131)*cos_e_rram_system[7]
    cos_ternary_gpu_num = 908+(908-13)+(908-13-160)+(908-13-160-162)+(908-13-160-162-188)+(908-13-160-162-188-253)+(908-13-160-162-188-253-1)+ (908-13-160-162-188-253-1-131)
    ...
    e_cim =  e_mix_early_exit_ternary_conv_system
    e_cim_rram =  908 * layer1_e_rram + (908-13) * layer2_e_rram + (908-13-160) * layer3_e_rram + (908-13-160-162) * layer4_e_rram + \
                                           (908-13-160-162-188) * layer5_e_rram + (908-13-160-162-188-253) * layer6_e_rram + (908-13-160-162-188-253-1) * layer7_e_rram \
                                            + (908-13-160-162-188-253-1-131) * layer8_e_mix
    e_cim_gpu = 908 * layer1_e_mixgpu + (908-13) * layer2_e_mixgpu + (908-13-160) * layer3_e_mixgpu + (908-13-160-162) * layer4_e_mixgpu + \
                                           (908-13-160-162-188) * layer5_e_mixgpu + (908-13-160-162-188-253) * layer6_e_mixgpu + (908-13-160-162-188-253-1) * layer7_e_mixgpu \
                                            + (908-13-160-162-188-253-1-131) * layer8_e_mixgpu
    e_cim_adc = 908 * layer1_e_adc + (908-13) * layer2_e_adc + (908-13-160) * layer3_e_adc + (908-13-160-162) * layer4_e_adc + \
                                           (908-13-160-162-188) * layer5_e_adc + (908-13-160-162-188-253) * layer6_e_adc + (908-13-160-162-188-253-1) * layer7_e_adc \
                                            + (908-13-160-162-188-253-1-131) * layer8_e_adc
    ...
    #rram_system
    e_rram_early_exit_system = 908 * layer1_e_rram + (908-13) * layer2_e_rram + (908-13-160) * layer3_e_rram + (908-13-160-162) * layer4_e_rram + \
                                           (908-13-160-162-188) * layer5_e_rram + (908-13-160-162-188-253) * layer6_e_rram + (908-13-160-162-188-253-1) * layer7_e_rram \
